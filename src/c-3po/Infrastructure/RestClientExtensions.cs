...
namespace c_3po
{
    public static class RestClientExtensions
    {
        ...
        public static IRestRequest AddAuthorizationBasicHeader(this IRestRequest request, Authenticator auth)
        {
            return request.AddHeader("Authorization", "Basic " + auth.AccessToken);
        }
    }
}
